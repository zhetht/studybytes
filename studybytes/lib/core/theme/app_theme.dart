  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.spaceGroteskTextTheme(ThemeData.dark().textTheme).copyWith(
        displayLarge: GoogleFonts.plusJakartaSans(fontSize: 32, fontWeight: FontWeight.w800, color: Colors.white),
        headlineMedium: GoogleFonts.plusJakartaSans(fontSize: 20, fontWeight: FontWeight.w700, color: Colors.white),
        bodyLarge: GoogleFonts.spaceGrotesk(fontSize: 16, color: Colors.white.withOpacity(0.9)),
        bodyMedium: GoogleFonts.spaceGrotesk(fontSize: 14, color: Colors.white.withOpacity(0.7)),
      ),
      ...
      navigationRailTheme: NavigationRailThemeData(
        ...
        selectedLabelTextStyle: GoogleFonts.spaceGrotesk(color: primaryBlue, fontWeight: FontWeight.w600),
        unselectedLabelTextStyle: GoogleFonts.spaceGrotesk(color: Colors.white.withOpacity(0.4)),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: GoogleFonts.spaceGrotesk(color: lavender, fontSize: 12, fontWeight: FontWeight.w500),
